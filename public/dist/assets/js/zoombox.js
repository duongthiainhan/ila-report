...
<img class='zoombox-image slide' src='${clientRootDir}dist/images/other/zoombox/load.svg'>
...
<img class='zoombox-close zoombox-controls' src='dist/images/other/zoombox/close.png'>
<img class='zoombox-next zoombox-controls' src='${clientRootDir}dist/images/other/zoombox/next.png'>
<img class='zoombox-prev zoombox-controls' src='${clientRootDir}dist/images/other/zoombox/prev.png'>
<img class='zoombox-play zoombox-controls' src='${clientRootDir}dist/images/other/zoombox/play.png'>
<img class='zoombox-zoom-in zoombox-controls' src='${clientRootDir}dist/images/other/zoombox/zoom-in.svg'>
<img class='zoombox-zoom-out zoombox-controls' src='${clientRootDir}dist/images/other/zoombox/zoom-out.svg'>
...
class zoomboxImages {
	...
	putImage(){
				...
				this.zoomboxImage.src = `${clientRootDir}dist/images/other/zoombox/load.svg`;
	...
	checkPlay(isplay){
		...
		if (isplay) {
			this.isplaying = false;
			this.zoomboxPlay.src = `${clientRootDir}dist/images/other/zoombox/play.png`;
			clearTimeout(this.slideTimeOut);
		} else {
			this.isplaying = true;
			this.zoomboxPlay.src = `${clientRootDir}dist/images/other/zoombox/pause.png`;
			this.slideShow();	
		}
	}
	...
	nextPrevImage(imageIndex){
		...
		this.zoomboxImage.src = `${clientRootDir}dist/images/other/zoombox/load.svg`; //show loading icon untill image loads up
	...
	groupName.forEach( (group)=>{
		...
		images.forEach( (img,index)=>{
			img.onclick = ()=>{ 
				...
				console.log('execute');
				zoombox.execute();
				console.log(`${clientRootDir}images/close.png`);
				document.querySelector('.zoombox-close').src = `${clientRootDir}dist/images/other/zoombox/close.png`;
				document.querySelector('.zoombox-zoom-in').src = `${clientRootDir}dist/images/other/zoombox/zoom-in.svg`;
				document.querySelector('.zoombox-zoom-out').src = `${clientRootDir}dist/images/other/zoombox/zoom-out.svg`;
				document.querySelector('.zoombox-next').src = `${clientRootDir}dist/images/other/zoombox/next.png`;
				document.querySelector('.zoombox-prev').src = `${clientRootDir}dist/images/other/zoombox/prev.png`;
				document.querySelector('.zoombox-play').src = `${clientRootDir}dist/images/other/zoombox/play.png`;
